...
cd /cluster/work/users/magdalena/lncrna/7_featurecounts/7_featurecounts_lncpartner_transcript/
...
-o /cluster/work/users/magdalena/lncrna/7_featurecounts/7_featurecounts_lncpartner_transcript/${output[$SLURM_ARRAY_TASK_ID]}\
