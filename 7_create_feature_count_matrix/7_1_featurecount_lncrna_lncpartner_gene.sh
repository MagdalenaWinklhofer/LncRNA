...
cd /cluster/work/users/magdalena/lncrna/7_featurecounts/7_featurecounts_lncpartner_gene/
...
#gene level 
featureCounts \
-T 4  -C -p --countReadPairs -s 2 -t exon -g gene_id \
-a /cluster/work/users/magdalena/lncrna/genome_index/carcar_annotation_v5.gtf \
-o /cluster/work/users/magdalena/lncrna/7_featurecounts/7_featurecounts_lncpartner_gene/${output[$SLURM_ARRAY_TASK_ID]}\
